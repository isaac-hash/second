...
<body>
    ...
    <div class="container h-screen" style="width: 95%; margin: auto;">
        <!-- nav section -->
        <nav class="px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                ...
                <li>
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownNavbar" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 1311px);">
